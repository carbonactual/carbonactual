...
test('core graph exposes specialist packs without changing the governing core',()=>{
  assert.deepEqual(graph.specialistPacks,['MISSION_INTELLIGENCE','CAPABILITY_ASSURANCE','CAPABILITY_BENCHMARK_AND_FALLBACK','OUTCOME_ANALYSIS','STEWARDSHIP','UNIVERSAL_KNOWLEDGE_MASTERY','REASONING_SUBSTRATE_BINDING','LIVE_SUBSTRATE_HEALTH','EVIDENCE_SOURCE_INTELLIGENCE','HUMAN_COORDINATION','OPERATIONAL_SAFETY_ENVELOPE','IDENTITY_RELATIONSHIP_PRIVACY','UNIVERSAL_COMMUNICATION','WORKSPACE_ARTIFACT_INTELLIGENCE','ROLE_RESPONSIBILITY_ACCOUNTABILITY']);
