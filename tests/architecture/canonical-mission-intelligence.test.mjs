...
test('specialist packs cover mission intelligence, capability assurance, outcomes and stewardship',()=>{
  assert.equal(contract.packs.length,5);
...
test('core graph exposes specialist packs without changing the governing core',()=>{
  assert.deepEqual(graph.specialistPacks,['MISSION_INTELLIGENCE','CAPABILITY_ASSURANCE','OUTCOME_ANALYSIS','STEWARDSHIP','UNIVERSAL_KNOWLEDGE_MASTERY']);
